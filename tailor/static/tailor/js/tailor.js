/**
 * TailorX - Premium Custom Boutique
...
$(document).ready(function() {
    ...
    $('.gallery-filters').on('click', '.btn-filter', function() {
        ...
        $('.gallery-filters .btn-filter').removeClass('active btn-gold').addClass('btn-outline-dark');
        $(this).addClass('active btn-gold').removeClass('btn-outline-dark');
    ...
    $('#ajax-booking-form').on('submit', function(e) {
        ...
        submitBtn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Staging Slot...');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    ...
                    var errHTML = '<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Error!</strong> Fix validation errors:<ul>';
            ...
            error: function() {
                ...
                formResult.html(
                    '<div class="alert alert-danger alert-dismissible fade show" role="alert">' +
                        '<strong>Error!</strong> Failed to process booking. Please try again.' +
                        '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' +
                    '</div>'
                );
            }
    ...
    $('#ajax-contact-form').on('submit', function(e) {
        ...
        submitBtn.prop('disabled', true).html('Sending message...');
            ...
            error: function() {
                ...
                formResult.html(
                    '<div class="alert alert-danger" role="alert">' +
                        'Oops, something went wrong. Please check fields and retry.' +
                    '</div>'
                );
            }
        });
